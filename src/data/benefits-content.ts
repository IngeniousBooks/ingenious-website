...
export const benefitsContent: Array<BenefitContent> = [
  {
    iconURL: "public/assets/icons/ingenious-book-icon.svg",
  ...
  {
    iconURL: "public/assets/icons/ingenious-happy-icon.svg",
  ...
  {
    iconURL: "public/assets/icons/ingenious-roadmap-icon.svg",
